...
#define libuna_codepage_windows_1250_byte_stream_to_unicode( byte_stream_character ) \
	( byte_stream_character < 0x80 ) ? byte_stream_character : libuna_codepage_windows_1250_byte_stream_to_unicode_base_0x80[ byte_stream_character - 0x80 ]
...
#define libuna_codepage_windows_1250_unicode_to_byte_stream( unicode_character ) \
	...
	( ( unicode_character >= 0x00a0 ) && ( unicode_character < 0x0120 ) ) ? libuna_codepage_windows_1250_unicode_to_byte_stream_base_0x00a0[ unicode_character - 0x00a0 ] : \
	( ( unicode_character >= 0x0138 ) && ( unicode_character < 0x0180 ) ) ? libuna_codepage_windows_1250_unicode_to_byte_stream_base_0x0138[ unicode_character - 0x0138 ] : \
	( unicode_character == 0x02c7 ) ? 0xa1 : \
	( ( unicode_character >= 0x02d8 ) && ( unicode_character < 0x02e0 ) ) ? libuna_codepage_windows_1250_unicode_to_byte_stream_base_0x02d8[ unicode_character - 0x02d8 ] : \
