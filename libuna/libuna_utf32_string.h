...
LIBUNA_EXTERN ssize_t libuna_utf32_string_size_from_byte_stream(
                       uint8_t *byte_stream,
...
LIBUNA_EXTERN ssize_t libuna_utf32_string_size_from_utf8(
...
LIBUNA_EXTERN ssize_t libuna_utf32_string_size_from_utf8_stream(
...
LIBUNA_EXTERN ssize_t libuna_utf32_string_size_from_utf16(
...
LIBUNA_EXTERN ssize_t libuna_utf32_string_size_from_utf16_stream(
...
LIBUNA_EXTERN ssize_t libuna_utf32_string_size_from_utf32_stream(
                       uint8_t *utf32_stream,
                       size_t utf32_stream_size,
                       uint8_t byte_order );
