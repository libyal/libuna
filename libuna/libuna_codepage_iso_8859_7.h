...
#define libuna_codepage_iso_8859_7_byte_stream_to_unicode( byte_stream, byte_stream_index ) \
	( byte_stream[ byte_stream_index ] < 0xa0 ) ? \
		byte_stream[ byte_stream_index ] : \
	libuna_codepage_iso_8859_7_byte_stream_to_unicode_base_0xa0[ byte_stream[ byte_stream_index ] - 0xa0 ]
...
#define libuna_codepage_iso_8859_7_unicode_to_byte_stream( unicode_character ) \
	...
	( ( unicode_character >= 0x00a0 ) && ( unicode_character < 0x00b8 ) ) ? \
		libuna_codepage_iso_8859_7_unicode_to_byte_stream_base_0x00a0[ unicode_character - 0x00a0 ] : \
	( unicode_character == 0x00bb ) ? \
		0xbb : \
	( unicode_character == 0x00bd ) ? \
		0xbd : \
	( unicode_character == 0x037a ) ? \
		0xaa : \
	( ( unicode_character >= 0x0380 ) && ( unicode_character < 0x03d0 ) ) ? \
		libuna_codepage_iso_8859_7_unicode_to_byte_stream_base_0x0380[ unicode_character - 0x0380 ] : \
	( unicode_character == 0x2016 ) ? \
		0xaf : \
	( unicode_character == 0x2018 ) ? \
		0xa1 : \
	( unicode_character == 0x2019 ) ? \
		0xa2 : \
	( unicode_character == 0x20ac ) ? \
		0xa4 : \
	( unicode_character == 0x20af ) ? \
		0xa5 : \
	0x1a
