...
#define libuna_codepage_iso_8859_2_byte_stream_to_unicode( byte_stream_character ) \
	( byte_stream_character < 0xa0 ) ? byte_stream_character : libuna_codepage_iso_8859_2_byte_stream_to_unicode_base_0x80[ byte_stream_character - 0xa0 ]

#define libuna_codepage_iso_8859_2_unicode_to_byte_stream( unicode_character ) \
	( unicode_character < 0x00c0 ) ? (uint8_t) unicode_character : \
	...
	( ( unicode_character >= 0x02d8 ) && ( unicode_character < 0x02e0 ) ) ? libuna_codepage_iso_8859_2_unicode_to_byte_stream_base_0x02d8[ unicode_character - 0x02d8 ] : 0x1a
