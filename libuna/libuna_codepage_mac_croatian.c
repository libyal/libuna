 ...
 */
const uint8_t libuna_codepage_mac_croatian_unicode_to_byte_stream_base_0x00a0[ 114 ] = {
...
const uint8_t libuna_codepage_mac_croatian_unicode_to_byte_stream_base_0x2010[ 53 ] = {
