...
const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x03b1[ 17 ][ 2 ] = {
	                { 0x83, 0xbf }, { 0x83, 0xc0 }, { 0x83, 0xc1 }, { 0x83, 0xc2 }, { 0x83, 0xc3 }, { 0x83, 0xc4 }, { 0x83, 0xc5 },
	{ 0x83, 0xc6 }, { 0x83, 0xc7 }, { 0x83, 0xc8 }, { 0x83, 0xc9 }, { 0x83, 0xca }, { 0x83, 0xcb }, { 0x83, 0xcc }, { 0x83, 0xcd },
	{ 0x83, 0xce }, { 0x83, 0xcf }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x03c3[ 7 ][ 2 ] = {
	                                                { 0x83, 0xd0 }, { 0x83, 0xd1 }, { 0x83, 0xd2 }, { 0x83, 0xd3 }, { 0x83, 0xd4 },
	{ 0x83, 0xd5 }, { 0x83, 0xd6 }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x0410[ 64 ][ 2 ] = {
...
const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x2160[ 10 ][ 2 ] = {
	{ 0x87, 0x54 }, { 0x87, 0x55 }, { 0x87, 0x56 }, { 0x87, 0x57 }, { 0x87, 0x58 }, { 0x87, 0x59 }, { 0x87, 0x5a }, { 0x87, 0x5b },
	{ 0x87, 0x5c }, { 0x87, 0x5d }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x2170[ 10 ][ 2 ] = {
	{ 0xee, 0xef }, { 0xee, 0xf0 }, { 0xee, 0xf1 }, { 0xee, 0xf2 }, { 0xee, 0xf3 }, { 0xee, 0xf4 }, { 0xee, 0xf5 }, { 0xee, 0xf6 },
	{ 0xee, 0xf7 }, { 0xee, 0xf8 }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x2460[ 20 ][ 2 ] = {
...
const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x3005[ 17 ][ 2 ] = {
	                                                                                { 0x81, 0x58 }, { 0x81, 0x59 }, { 0x81, 0x5a },
	{ 0x81, 0x71 }, { 0x81, 0x72 }, { 0x81, 0x73 }, { 0x81, 0x74 }, { 0x81, 0x75 }, { 0x81, 0x76 }, { 0x81, 0x77 }, { 0x81, 0x78 },
	{ 0x81, 0x79 }, { 0x81, 0x7a }, { 0x81, 0xa7 }, { 0x81, 0xac }, { 0x81, 0x6b }, { 0x81, 0x6c }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x3041[ 83 ][ 2 ] = {
	                { 0x82, 0x9f }, { 0x82, 0xa0 }, { 0x82, 0xa1 }, { 0x82, 0xa2 }, { 0x82, 0xa3 }, { 0x82, 0xa4 }, { 0x82, 0xa5 },
	...
	{ 0x82, 0xee }, { 0x82, 0xef }, { 0x82, 0xf0 }, { 0x82, 0xf1 }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x30a1[ 86 ][ 2 ] = {
	                { 0x83, 0x40 }, { 0x83, 0x41 }, { 0x83, 0x42 }, { 0x83, 0x43 }, { 0x83, 0x44 }, { 0x83, 0x45 }, { 0x83, 0x46 },
	...
	{ 0x83, 0x90 }, { 0x83, 0x91 }, { 0x83, 0x92 }, { 0x83, 0x93 }, { 0x83, 0x94 }, { 0x83, 0x95 }, { 0x83, 0x96 }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x9eb8[ 5 ][ 2 ] = {
	{ 0xea, 0x6f }, { 0x8d, 0x8d }, { 0x96, 0xcb }, { 0x96, 0x83 }, { 0x9b, 0xf5 }
};

const uint8_t libuna_codepage_windows_932_unicode_to_byte_stream_base_0x9ecc[ 8 ][ 2 ] = {
	                                                { 0xea, 0x73 }, { 0x8b, 0x6f }, { 0xea, 0x74 }, { 0xea, 0x75 },
	{ 0xea, 0x76 }, { 0xee, 0xec }, { 0x8d, 0x95 },
};
