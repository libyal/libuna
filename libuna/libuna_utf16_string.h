...
LIBUNA_EXTERN ssize_t libuna_utf16_string_size_from_byte_stream(
                       uint8_t *byte_stream,
...
LIBUNA_EXTERN ssize_t libuna_utf16_string_size_from_utf8(
...
LIBUNA_EXTERN ssize_t libuna_utf16_string_size_from_utf8_stream(
...
LIBUNA_EXTERN ssize_t libuna_utf16_string_size_from_utf16_stream(
                       uint8_t *utf16_stream,
                       size_t utf16_stream_size,
                       uint8_t byte_order );
...
LIBUNA_EXTERN ssize_t libuna_utf16_string_size_from_utf32(
...
LIBUNA_EXTERN ssize_t libuna_utf16_string_size_from_utf32_stream(
