 ...
 */
const uint8_t libuna_codepage_mac_russian_unicode_to_byte_stream_base_0x00a0[ 28 ] = {
...
const uint8_t libuna_codepage_mac_russian_unicode_to_byte_stream_base_0x2010[ 23 ] = {
