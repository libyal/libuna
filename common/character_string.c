              ...
              size_t size )
{
	...
	static char *function  = "libuca_string_duplicate";
     ...
     int64_t *value )
{
	...
	static char *function      = "libuca_string_to_int64";
...
{
	character_t *end_of_string = NULL;
	static char *function      = "libuca_string_to_uint64";
              ...
              size_t size )
{
	...
	static char *function = "libuca_string_ctime";
