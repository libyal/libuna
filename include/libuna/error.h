...
enum LIBUNA_ARGUMENT_ERROR
{
	 ...
	 */
	LIBUNA_ARGUMENT_ERROR_VALUE_OUT_OF_RANGE     = 7,
...
#define LIBUNA_COMPRESSION_ERROR_UNCOMPRESS_FAILED	LIBUNA_COMPRESSION_ERROR_DECOMPRESS_FAILED
...
enum LIBUNA_INPUT_ERROR
{
	 ...
	 */
	LIBUNA_INPUT_ERROR_CRC_MISMATCH              = 3,
	 ...
	 */
	LIBUNA_INPUT_ERROR_MISSING_LAST_SEGMENT_FILE = 5,

	/* The last section is missing from the input
	 */
	LIBUNA_INPUT_ERROR_MISSING_LAST_SECTION      = 6
};
...
enum LIBUNA_RUNTIME_ERROR
{
	 ...
	 */
	LIBUNA_RUNTIME_ERROR_VALUE_OUT_OF_RANGE      = 12,
