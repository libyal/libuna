/*
 * Library codepage_windows_936 functions test program
 *
 ...
 */
int una_test_codepage_windows_936_unicode_character_size_to_byte_stream(
     void )
{
	...
	for( test_number = 0;
	     ...
	     test_number++ )
	{
		test_values = &( una_test_codepage_windows_936_byte_stream_to_unicode[ test_number ] );
...
/* Tests the libuna_codepage_windows_936_copy_from_byte_stream function
 * Returns 1 if successful or 0 if not
 */
int una_test_codepage_windows_936_copy_from_byte_stream(
     void )
{
	libuna_error_t *error                          = NULL;
	una_test_byte_stream_to_unicode_t *test_values = NULL;
...
/* Tests the libuna_codepage_windows_936_copy_to_byte_stream function
 * Returns 1 if successful or 0 if not
 */
int una_test_codepage_windows_936_copy_to_byte_stream(
     void )
{
...
#endif
{
	...
	UNA_TEST_RUN(
	 "libuna_codepage_windows_936_unicode_character_size_to_byte_stream",
	 una_test_codepage_windows_936_unicode_character_size_to_byte_stream );

	UNA_TEST_RUN(
	 "libuna_codepage_windows_936_copy_from_byte_stream",
	 una_test_codepage_windows_936_copy_from_byte_stream );

	UNA_TEST_RUN(
	 "libuna_codepage_windows_936_copy_to_byte_stream",
	 una_test_codepage_windows_936_copy_to_byte_stream );
