...
/* Tests the libuna_unicode_character_size_to_utf8_rfc2279 function
 * Returns 1 if successful or 0 if not
 */
int una_test_unicode_character_size_to_utf8_rfc2279(
     void )
{
	libuna_error_t *error      = NULL;
	size_t utf8_character_size = 0;
...
/* Tests the libuna_unicode_character_copy_from_utf8_rfc2279 function
 * Returns 1 if successful or 0 if not
 */
int una_test_unicode_character_copy_from_utf8_rfc2279(
     void )
{
	uint8_t utf8_stream1[ 2 ]                    = { 'A', 0 };
	uint8_t utf8_stream2[ 5 ]                    = { 0xf0, 0x9f, 0xa7, 0xaa, 0 };
...
/* Tests the libuna_unicode_character_copy_to_utf8_rfc2279 function
 * Returns 1 if successful or 0 if not
 */
int una_test_unicode_character_copy_to_utf8_rfc2279(
     void )
{
	uint8_t utf8_string[ 16 ];
...
#endif
{
	...
	UNA_TEST_RUN(
	 ...
	 una_test_unicode_character_size_to_utf8_rfc2279 );

	UNA_TEST_RUN(
	 "libuna_unicode_character_copy_from_utf8_rfc2279",
	 una_test_unicode_character_copy_from_utf8_rfc2279 );

	UNA_TEST_RUN(
	 "libuna_unicode_character_copy_to_utf8_rfc2279",
	 una_test_unicode_character_copy_to_utf8_rfc2279 );
