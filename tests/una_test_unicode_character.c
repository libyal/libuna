...
{
	libuna_error_t *error              = NULL;
	size_t utf16_stream_character_size = 0;
	int result                         = 0;
...
{
	libuna_error_t *error              = NULL;
	size_t utf32_stream_character_size = 0;
	int result                         = 0;
