...
$LibraryTests = "base16_stream base32_stream byte_stream codepage_windows_932 codepage_windows_936 codepage_windows_949 codepage_windows_950 error support unicode_character url_stream utf16_stream utf16_string utf32_stream utf32_string utf7_stream utf8_stream utf8_string"
