/*
 * Unicode and ASCII (byte stream) conversion library UTF-32 string copy from testing program
 *
...
/* Tests copying an UTF-32 string from a byte stream
     ...
     int expected_result )
{
	...
	size_t result_utf32_string_size = 0;
	int result                      = 0;

	fprintf(
	 stdout,
	 "Testing copying UTF-32 string from byte stream\t" );

	result = libuna_utf32_string_size_from_byte_stream(
	          byte_stream,
	          byte_stream_size,
	          codepage,
	          &result_utf32_string_size,
	          &error );

	if( result == 1 )
	{
		if( result_utf32_string_size != expected_utf32_string_size )
		{
			result = 0;
		}
	}
	...
	if( result == 1 )
	{
		if( memory_compare(
		     ...
		     sizeof( uint32_t ) * expected_utf32_string_size ) != 0 )
		{
			result = 0;
		}
	}
...
/* Tests copying an UTF-32 string from an UTF-7 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	fprintf(
	 stdout,
	 "Testing copying UTF-32 string from UTF-7 stream\t" );
...
/* Tests copying an UTF-32 string from an UTF-8 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	fprintf(
	 stdout,
	 "Testing copying UTF-32 string from UTF-8 stream\t" );
...
/* Tests copying an UTF-32 string from an UTF-16 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	fprintf(
	 stdout,
	 "Testing copying UTF-32 string from UTF-16 stream with byte-order: %s\t",
	 byte_order_string );
...
/* Tests copying an UTF-32 string from an UTF-32 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	fprintf(
	 stdout,
	 "Testing copying UTF-32 string from UTF-32 stream with byte-order: %s\t",
	 byte_order_string );
...
/* Tests copying an UTF-32 string from an UTF-8 string
 * Returns 1 if successful, 0 if not or -1 on error
 */
int una_test_utf32_string_copy_from_utf8_string(
     ...
     int expected_result )
{
	...
	fprintf(
	 stdout,
	 "Testing copying UTF-32 string from UTF-8 string\t" );
...
/* Tests copying an UTF-32 string from an UTF-16 string
 * Returns 1 if successful, 0 if not or -1 on error
 */
int una_test_utf32_string_copy_from_utf16_string(
     ...
     int expected_result )
{
	...
	fprintf(
	 stdout,
	 "Testing copying UTF-32 string from UTF-16 string\t" );
...
#endif
{
	...
	uint32_t expected_utf32_string[ 16 ] = { 'T', 'h', 'i', 's', ' ', 'i', 's', ' ', 0xe1, ' ', 't', 'e', 's', 't', '.', 0 };
	 ...
	 *         UTF-32 string is a buffer, UTF-32 string size is 256
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_byte_stream(
	     NULL,
	     16,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy byte stream to UTF-32 string.\n" );
	 ...
	 *         UTF-32 string is a buffer, UTF-32 string size is 8
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_byte_stream(
	     byte_stream,
	 ...
	 *         UTF-32 string is NULL, UTF-32 string size is 256
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_byte_stream(
	     byte_stream,
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_utf7_stream(
	     NULL,
	     20,
	     utf32_string,
	     256,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-7 stream to UTF-32 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_utf8_stream(
	     NULL,
	     17,
	     utf32_string,
	     256,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-8 stream to UTF-32 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_utf16_stream(
	     NULL,
	     32,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-16 stream to UTF-32 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_utf32_stream(
	     NULL,
	     64,
	     LIBUNA_ENDIAN_LITTLE,
	     utf32_string,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-32 stream to UTF-32 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_utf8_string(
	     NULL,
	     17,
	     utf32_string,
	     256,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-8 string to UTF-32 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf32_string_copy_from_utf16_string(
	     NULL,
	     16,
	     utf32_string,
	     256,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-16 string to UTF-32 string.\n" );
