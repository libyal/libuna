/*
 * Unicode and ASCII (byte stream) conversion library UTF-8 string copy from testing program
 *
     ...
     int expected_result )
{
	...
	int result                     = 0;
        ...
        fprintf(
         stdout,
         "Testing copying UTF-8 string from byte stream\t" );
...
/* Tests copying an UTF-8 string from an UTF-7 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	int result                     = 0;
        ...
        fprintf(
         stdout,
         "Testing copying UTF-8 string from UTF-7 stream\t" );
...
/* Tests copying an UTF-8 string from an UTF-8 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	int result                     = 0;
        ...
        fprintf(
         stdout,
         "Testing copying UTF-8 string from UTF-8 stream\t" );
...
/* Tests copying an UTF-8 string from an UTF-16 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	else if( byte_order == LIBUNA_ENDIAN_LITTLE )
	{
        ...
        fprintf(
         stdout,
         "Testing copying UTF-8 string from UTF-16 stream with byte-order: %s\t",
	 byte_order_string );
...
/* Tests copying an UTF-8 string from an UTF-32 stream
 * Returns 1 if successful, 0 if not or -1 on error
 */
     ...
     int expected_result )
{
	...
	else if( byte_order == LIBUNA_ENDIAN_LITTLE )
	{
        ...
        fprintf(
         stdout,
         "Testing copying UTF-8 string from UTF-32 stream with byte-order: %s\t",
	 byte_order_string );
...
#endif
{
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf8_string_copy_from_byte_stream(
	     NULL,
	     16,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy byte stream to UTF-8 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf8_string_copy_from_utf8_stream(
	     NULL,
	     17,
	     utf8_string,
	     256,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-8 stream to UTF-8 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf8_string_copy_from_utf16_stream(
	     NULL,
	     32,
	     ...
	     -1 ) != 1 )
	{
		fprintf(
		 stderr,
		 "Unable to copy UTF-16 stream to UTF-8 string.\n" );
	 ...
	 * Expected result: -1
	 */
	if( una_test_utf8_string_copy_from_utf32_stream(
	     NULL,
	     64,
	     LIBUNA_ENDIAN_LITTLE,
	     utf8_string,
