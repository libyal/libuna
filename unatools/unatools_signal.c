             ...
             unsigned long signal )
{
	...
	switch( signal )
	{
		...
		case CTRL_C_EVENT:
			if( unatools_signal_signal_handler != NULL )
			{
				unatools_signal_signal_handler(
				 signal );
			}
			return( TRUE );
...
{
	static char *function = "unatools_signal_attach";
...
#if defined( _MSC_VER )
	unatools_signal_initialize_memory_debug();
#endif
     ...
     libcerror_error_t **error )
{
	...
	unatools_signal_signal_handler = NULL;
