...
#if !defined( _UNATOOLS_GETOPT_H )
#define _UNATOOLS_GETOPT_H
...
typedef struct unatools_option unatools_option_t;

struct unatools_option
{
...
#define unatools_getopt( argument_count, argument_values, options_string ) \
...
system_integer_t unatools_getopt(
                  int argument_count,
...
void unatools_getopt_wrapped_fprint(
      FILE *stream,
...
void unatools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const unatools_option_t *options,
      int number_of_options );

int unatools_getopt_get_options_string(
     const unatools_option_t *options,
     int number_of_options,
...
#endif /* !defined( _UNATOOLS_GETOPT_H ) */
