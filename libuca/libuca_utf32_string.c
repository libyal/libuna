 ...
 * Returns 1 if successful or -1 on error
 */
ssize_t libuca_utf32_string_size_from_utf8_stream(
         uint8_t *utf8_stream,
         size_t utf8_stream_size )
{
	static char *function                        = "libuca_utf32_string_size_from_utf8_stream";
 ...
 * Returns 1 if successful or -1 on error
 */
int libuca_utf32_string_copy_from_utf8_stream(
     libuca_utf32_character_t *utf32_string,
     size_t utf32_string_size,
     uint8_t *utf8_stream,
     size_t utf8_stream_size )
{
	static char *function                        = "libuca_utf32_string_copy_from_utf8_stream";
	size_t utf32_string_iterator                 = 0;
	size_t utf8_stream_iterator                  = 0;
	libuca_unicode_character_t unicode_character = 0;
	uint8_t zero_byte                            = 0;
