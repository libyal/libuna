 ...
 */
ssize_t libuca_utf32_string_size_from_sbc(
         uint8_t *sbc_string,
         size_t sbc_string_size,
         int code_page,
         uint8_t strict_mode )
{
	static char *function                        = "libuca_utf32_string_size_from_sbc";
 ...
 * Returns 1 if successful or -1 on error
 */
int libuca_utf32_string_copy_from_sbc(
     ...
     uint8_t strict_mode )
{
	static char *function                        = "libuca_utf32_string_copy_from_sbc";
 ...
 * Returns 1 if successful or -1 on error
 */
int libuca_utf32_string_copy_to_sbc(
     libuca_utf32_character_t *utf32_string,
     size_t utf32_string_size,
     uint8_t *sbc_string,
     size_t sbc_string_size,
     ...
     uint8_t strict_mode )
{
	static char *function                        = "libuca_utf32_string_copy_to_sbc";
	size_t utf32_string_iterator                 = 0;
	size_t sbc_string_iterator                   = 0;
	libuca_unicode_character_t unicode_character = 0;
 ...
 * Returns 1 if successful or -1 on error
 */
int libuca_utf32_string_copy_to_utf16_stream(
     libuca_utf32_character_t *utf32_string,
     size_t utf32_string_size,
     uint8_t *utf16_stream,
     size_t utf16_stream_size,
     ...
     uint8_t strict_mode )
{
	static char *function                        = "libuca_utf32_string_copy_to_utf16_stream";
	size_t utf32_string_iterator                 = 0;
	size_t utf16_stream_iterator                 = 0;
	libuca_unicode_character_t unicode_character = 0;
