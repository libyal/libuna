 ...
 * Returns 1 if successful or -1 on error
 */
int libuca_utf8_string_copy_to_byte_stream(
     libuca_utf8_character_t *utf8_string,
     size_t utf8_string_size,
     uint8_t *byte_stream,
     size_t byte_stream_size,
     ...
     uint8_t strict_mode )
{
	static char *function                        = "libuca_utf8_string_copy_to_byte_stream";
	size_t utf8_string_iterator                  = 0;
	size_t byte_stream_iterator                  = 0;
	libuca_unicode_character_t unicode_character = 0;
 ...
 * Returns 1 if successful or -1 on error
 */
int libuca_utf8_string_copy_to_utf16_stream(
     libuca_utf8_character_t *utf8_string,
     size_t utf8_string_size,
     uint8_t *utf16_stream,
     size_t utf16_stream_size,
     ...
     uint8_t strict_mode )
{
	static char *function                        = "libuca_utf8_string_copy_to_utf16_stream";
	size_t utf8_string_iterator                  = 0;
	size_t utf16_stream_iterator                 = 0;
	libuca_unicode_character_t unicode_character = 0;
